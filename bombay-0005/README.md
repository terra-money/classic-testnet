...
$ sed -i 's/minimum-gas-prices = ""/minimum-gas-prices = "0.15uluna,0.1018usdr,0.15uusd,178.05ukrw,431.6259umnt,0.125ueur,0.97ucny,16ujpy,0.11ugbp,11uinr,0.19ucad,0.13uchf,0.19uaud,0.2usgd,4.62uthb,1.25usek"/g' ~/.terra/config/app.toml
$ terrad start
```
