...
[core@v0.5.0-beta1](https://github.com/terra-money/core/releases/v0.5.0-beta1) and [core@v0.5.0-beta2](https://github.com/terra-money/core/releases/v0.5.0-beta2) both can be used to run the testnet.
...
$ wget https://raw.githubusercontent.com/terra-money/testnet/master/bombay-0005/genesis.json
